...
EULER jest programem do szybkich i interaktywnych obliczeń na liczbach
rzeczywistych i zespolonych, z przedziałami, w stylu MatLaba,
Octave... Może narysować i animować funkcje w dwóch lub trzech
wymiarach.
